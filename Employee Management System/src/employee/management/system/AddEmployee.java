...
public class AddEmployee extends JFrame implements ActionListener {
    ...
    AddEmployee() {
        ...
        String courses[] = {"BE", "ME", "B.TECH", "M.TECH", "BA", "BBA", "B.COM", "MCA", "BSC", "BCA", "PHD"};
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try {
                Conn conn = new Conn();
                String query = "INSERT INTO employee (name, fname, dob, salary, address, phone, email, education, designation, aadhar, empId) " +
                               "VALUES ('" + name + "', '" + fname + "', '" + dob + "', '" + salary + "', '" + address + "', '" + phone + "', '" +
    ...
    public static void main(String[] args) {
        new AddEmployee(); // This line will open the JFrame window
    }
}